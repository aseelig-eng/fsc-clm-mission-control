...
export const exceptions: ExceptionItem[] = [
  ...
  },
  {
    ...
    advisorActions: [
      {
        type: 'review_inputs',
        label: 'Confirm there is still no fact-find',
        detail: 'Name and email only. Do not invent risk or goals.',
      },
      {
        type: 'schedule',
        label: 'Use Monday’s intro to collect the minimum',
        detail: 'Phone, a goal, and whether assets will move.',
      },
      {
        type: 'delegate',
        label: 'Leave the IPS gated',
        detail: 'Paraplanner resumes only after discovery data lands.',
      },
    ],
  },
  {
