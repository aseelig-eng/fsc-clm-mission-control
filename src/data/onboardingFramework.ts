  ...
  h0: {
    ...
    sections: baseSections({
      ...
      extra: {
        ...
        household: { value: 'Not created', status: 'missing' },
  ...
  h2: {
    ...
    sections: baseSections({
      ...
      extra: {
        ...
        principalDate: { value: '—', status: 'missing' },
        custodian: { value: 'Altruist', status: 'partial' },
        custAcct: { value: 'Pending principal approval', status: 'missing' },
        acat: { value: 'Queued — $3.1M Fidelity', status: 'partial' },
        delivering: { value: 'Fidelity · …4410', status: 'complete' },
        fundStatus: { value: 'Not started', status: 'missing' },
        accredited: { value: 'Yes — CPA letter on file', status: 'complete' },
        qp: { value: 'Yes', status: 'complete' },
        alts: { value: 'PE sleeve under review', status: 'partial' },
        orientDate: { value: 'Thu — trust walkthrough hold', status: 'partial' },
        portal: { value: 'Not started', status: 'missing' },
        welcome: { value: 'Not started', status: 'missing' },
        billing: { value: 'Not started', status: 'missing' },
      },
  ...
  h3: {
    ...
    sections: baseSections({
      ...
      extra: {
        ...
        allocation: { value: '60/40', status: 'complete' },
  ...
  h4: {
    ...
    sections: baseSections({
      ...
      extra: {
        ...
        riskTol: { value: 'Successor TBD', status: 'partial' },
        riskCap: { value: 'Successor TBD', status: 'partial' },
        model: { value: 'Hold pending retitle', status: 'partial' },
        acctTypes: { value: 'Individual → Estate / Spouse', status: 'partial' },
        beneficiary: { value: 'Surviving spouse outreach open', status: 'partial' },
