  ...
  h1: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Engagement',
          score: 82,
          blurb: 'Fast replier; prefers short, decisive touches over long nurture drips.',
          evidence: ['Portal quiz completed same day', 'DocuSign in <4 hrs historically', 'Missed only 1 of 6 asks'],
          inferredBy: 'agent',
  ...
  h2: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Engagement',
          score: 60,
          blurb: 'Thoughtful, slower cadence; prefers scheduled depth over ping-pong chat.',
          evidence: ['In-person proposal', 'Email batching preferred', 'Rare portal logins'],
          inferredBy: 'mixed',
    ...
    },
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Engagement',
          score: 68,
          blurb: 'Engages deeply on family topics; skims market emails.',
          evidence: ['Asked about granddaughter trusted contact', 'Opened family agenda items'],
          inferredBy: 'mixed',
  ...
  h3: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Engagement',
          score: 76,
          blurb: 'Reliable annual/quarterly participant; portal used for prep.',
          evidence: ['Prep report opened', '2 life-change flags submitted'],
          inferredBy: 'agent',
    ...
    },
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Engagement',
          score: 55,
          blurb: 'Shows for AR; low async engagement.',
          evidence: ['Attends annual', 'Rare email replies'],
          inferredBy: 'agent',
    ...
    },
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Engagement',
          score: 45,
          blurb: 'Will engage if path is clear and humane.',
          evidence: ['Accepted intro meeting'],
          inferredBy: 'advisor',
