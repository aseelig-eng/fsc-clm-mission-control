  ...
  h1: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Goals & horizon',
          score: 76,
          blurb: 'Growth and a later home are named. Almost none of the growth goal is funded yet.',
        ...
        },
        {
          ...
          score: 50,
          blurb: 'Half of what we can see is still at Fidelity. The managed book is the other half.',
          evidence: ['$248K managed at Schwab', '$248K still at Fidelity', 'ACAT not settled'],
          inferredBy: 'agent',
        ...
        },
        {
          ...
          score: 62,
          blurb: 'Warm referral, and the first funding already came back from the custodian.',
  ...
  h2: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Goals & horizon',
          score: 72,
          blurb: 'Preserve and transfer are named. Nothing is funded until the account opens.',
        ...
        },
        {
          ...
          label: 'Share-of-wallet signal',
          score: 8,
          blurb: 'None of the $5.2M is on the firm’s books. The ACAT has not been submitted.',
          evidence: ['Held-away trust, holdco, and cash', 'Custodian account not opened'],
          inferredBy: 'agent',
    ...
    },
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Goals & horizon',
          score: 76,
          blurb: 'Family continuity is clear. The money has not moved.',
        ...
        },
        {
          ...
          label: 'Share-of-wallet signal',
          score: 8,
          blurb: 'Same household. Nothing has moved to the firm yet.',
          evidence: ['Joint decision on the transfer', 'Accounts still held away'],
          inferredBy: 'agent',
  ...
  h3: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Goals & horizon',
          score: 90,
          blurb: 'Tax-efficient retirement income is funded. The Roth window is the open piece.',
        ...
        },
        {
          ...
          label: 'Share-of-wallet signal',
          score: 90,
          blurb: 'About nine-tenths of what we can see is already here. The 401(k) is the piece outside.',
          evidence: ['$3.8M managed', 'Empower 401(k) still held away'],
          inferredBy: 'agent',
    ...
    },
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Share-of-wallet signal',
          score: 90,
          blurb: 'Same household. The managed book is already here.',
  ...
  h4: [
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Goals & horizon',
          score: 58,
          blurb: 'Settlement is defined. A successor spending plan is not.',
        ...
        },
        {
          ...
          label: 'Share-of-wallet signal',
          score: 96,
          blurb: 'The $1.1M is still here. The question is whether Amara stays.',
          evidence: ['$1.1M managed and frozen', 'Estate checking is the small piece outside'],
          inferredBy: 'advisor',
    ...
    },
    {
      ...
      facets: [
        ...
        },
        {
          ...
          label: 'Share-of-wallet signal',
          score: 96,
          blurb: 'The assets are still at the firm. Continuity is the open question, not a missing account.',
          evidence: ['$1.1M still at Schwab', 'Estate checking is outside'],
          inferredBy: 'agent',
